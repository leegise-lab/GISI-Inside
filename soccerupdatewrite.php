...
if ($inputpw != $info['pw']) {
    ...
    ?>
    <form name="tx_editor_form" id="tx_editor_form" action="soccerupdateservercheck.php" method="post">
        ...
        <div class="info_text">
            <input type="text" id="title" name="title" style="margin-left: 30%;margin-top: 10px; height: 30px; width: 615px" placeholder="제목을 입력해주세요." value="<?php echo $info['title']?>">
        </div>
            ...
            <script type="text/javascript">
                ...
                function submitContents(elClickedObj) {
                    ...
                    try {
                        ...
                        form2.action="soccerupdateservercheck.php";
