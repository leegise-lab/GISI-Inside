...
<form name="tx_editor_form" id="tx_editor_form" action="baseballpostserver.php" method="post" accept-charset="utf-8">
    <div class="info_text" style="margin-top: 20px">
        <?php if (isset($_SESSION[id])) {?>
        <input maxlength="6" type="text" id="id" name="id" style="margin-left: 30%; height: 30px; width: 300px" placeholder="닉네임" value="<?php echo $info['nick']?>"/><?php } else {?>
        <input maxlength="6" type="text" id="id" name="id" style="margin-left: 30%; height: 30px; width: 300px" placeholder="닉네임"/> <?php } ?>
        <input type="password" id="pw" name="pw" style="margin-left: 10px; height: 30px; width: 300px" placeholder="비밀번호"></div>
    <div class="info_text">
        <input maxlength="73" type="text" id="title" name="title" style="margin-left: 30%;margin-top: 10px; height: 30px; width: 615px" placeholder="제목을 입력해주세요."></div>
...
// var sHTML = "<span style='color:#FF0000;'>이미지도 같은 방식으로 삽입합니다.<\/span>";
                ...
                function submitContents(elClickedObj) {
                    ...
                    try {
                        ...
                        form2.action="baseballpostserver.php";
